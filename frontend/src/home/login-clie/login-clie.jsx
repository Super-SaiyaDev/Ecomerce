        ...
        <form onSubmit={handlerSumit}>
          <div className="input-groupt">
            ...
            <div className="input-feild">
              <Input onChange={onChange} type={"text"}  name={'user'} lblName={"name"} />
            </div>

            <div className="input-feild">
              <Input onChange={onChange} type={"email"}  name={'email'} lblName={"email"} />{" "}
            </div>

            <div className="input-feild">
              <Input onChange={onChange} type={"password"} name={'clave'} lblName={"Clave"} />{" "}
            </div>
